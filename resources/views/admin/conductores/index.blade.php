                                ...
                                <td>
                                    ...
                                    @if($c->carnet_habilitacion_tipo)
                                        <span class="text-sub" style="font-size: 10px; margin-top: 3px; font-weight: 600; color: var(--text3); display: inline-flex; align-items: center; gap: 3px;">
                                            <i class="fa-solid fa-address-card" style="font-size: 10px; color: #d97706;"></i> CH: {{ $c->carnet_habilitacion_tipo }} ({{ $c->carnet_habilitacion_vence ? \Carbon\Carbon::parse($c->carnet_habilitacion_vence)->format('d/m/Y') : 'S/V' }})
                                        </span>
                                    @endif
                                </td>
                                <td>
